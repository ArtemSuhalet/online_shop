...
urlpatterns = [
    ...
    path(
        "paymentcard/<int:order_id>/",
        PaymentWithCardView.as_view(),
        name="payment_with_card",
    ),
    path(
        "paymentaccount/<int:order_id>/",
        PaymentWithAccountView.as_view(),
        name="payment_with_account",
    ),
